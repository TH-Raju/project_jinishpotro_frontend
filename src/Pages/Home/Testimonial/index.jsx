      ...
      <section className="w-[90%] lg:w-[85%] mx-auto">
        <div className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          <div className="md:flex md:items-end md:justify-between">
            ...
            <button
              onClick={() =>
                toast.success("There are only 3 reviews! until now")
              }
              ...
              <div>
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-4 leading-relaxed ">
                    ...
                    shopping experience, Jinishpotro is the place to be.?
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-4 leading-relaxed ">
                    ...
                    attention to detail in ensuring the safety of the products
                    during transit did not go unnoticed.
                  </p>
                </div>
              </div>
